"""CLI 入口: python -m hermes_fry_cards [install|uninstall|status|verify]。"""
...
def _print_usage() -> None:
    print("Usage: python -m hermes_fry_cards <command>")
    print()
    print("Commands:")
...
def _cmd_status() -> int:
    ...
    if expected_py is not None:
        ...
        if current != expected_py.resolve():
            ...
            print(f"  rerun commands with: {expected_py} -m hermes_fry_cards ...")
